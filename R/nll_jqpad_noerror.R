jqpadne = function(pars, data_in = TMB_IN_DATA, debug = FALSE) {
  ...
  # lambda_r_num = exp(log_lambda_q - alpha_q * r_int_num)
  # lambda_r_den = exp(log_lambda_q - alpha_q * r_int_den)
  # lambda_r_num = exp(log_lambda_q - (alpha_q * r_int_num) ^ gamma_q)
  # lambda_r_den = exp(log_lambda_q - (alpha_q * r_int_den) ^ gamma_q)
  lambda_r_num = exp(log_lambda_q - (alpha_q * r_int_num) ^ 2)
  lambda_r_den = exp(log_lambda_q - (alpha_q * r_int_den) ^ 2)
